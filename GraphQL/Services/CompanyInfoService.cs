...
namespace KnowCrow.GraphQL.Clients
{
    ...
    public partial class CompanyInfoService 
    {
        private string _baseUrl = "";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public CompanyInfoService(IConfiguration configuration, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = configuration["CompanyInfoUrl"];
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<Company> CompaniesAsync(int id)
        {
            return CompaniesAsync(id, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Company> CompaniesAsync(int id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
